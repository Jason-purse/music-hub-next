    ...
    <div className="space-y-6">
      <form onSubmit={handleSearch}>
        <input value={q} onChange={e => setQ(e.target.value)} placeholder="搜索歌曲、歌手..."
          className="w-full h-12 px-5 text-base bg-white rounded-xl border border-gray-200 outline-none focus:ring-2 focus:ring-indigo-300 shadow-sm transition" />
      </form>
      ...
      {!loading && total > 0 && (
        <>
          <div className="text-sm text-gray-500">找到 {total} 首歌曲</div>
